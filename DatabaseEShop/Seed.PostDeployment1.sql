...
INSERT INTO products VALUES ('Dior Addict Lip Glow', 2, 1, 35.00, 45, GetDate(), SUSER_NAME(), GetDate(), SUSER_NAME()), ('BACKSTAGE Eyeshadow Palette', 2, 2, 49.00, 23, GetDate(), SUSER_NAME(), GetDate(), SUSER_NAME()), ('Killawatt Freestyle Highlighter', 4, 3, 38.00, 11, GetDate(), SUSER_NAME(), GetDate(), SUSER_NAME()), ('Stunna Lip Paint Longwear Fluid Lip Color', 4, 1, 26.00, 0, GetDate(), SUSER_NAME(), GetDate(), SUSER_NAME()), ('Fly Baby Mini Eye Primer and Liner Set', 4, 2, 24.00, 0, GetDate(), SUSER_NAME(), GetDate(), SUSER_NAME());
