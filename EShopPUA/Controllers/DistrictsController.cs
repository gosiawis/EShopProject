...
namespace EShopPUA.Controllers
{
    public class DistrictsController : Controller
    {
        ...
        public DistrictsController(DatabaseEShopContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Districts != null ? 
                          ...
                          Problem("Entity set 'DatabaseEShopContext.Districts'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'DatabaseEShopContext.Districts'  is null.");
            }
            var district = await _context.Districts.FindAsync(id);
            if (district != null)
            {
