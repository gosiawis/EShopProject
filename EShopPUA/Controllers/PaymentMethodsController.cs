...
namespace EShopPUA.Controllers
{
    public class PaymentMethodsController : Controller
    {
        ...
        public PaymentMethodsController(DatabaseEShopContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.PaymentMethods != null ? 
                          ...
                          Problem("Entity set 'DatabaseEShopContext.PaymentMethods'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'DatabaseEShopContext.PaymentMethods'  is null.");
            }
            var paymentMethod = await _context.PaymentMethods.FindAsync(id);
            if (paymentMethod != null)
            {
