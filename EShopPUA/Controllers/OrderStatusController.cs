...
namespace EShopPUA.Controllers
{
    public class OrderStatusController : Controller
    {
        ...
        public OrderStatusController(DatabaseEShopContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.OrderStatuses != null ? 
                          ...
                          Problem("Entity set 'DatabaseEShopContext.OrderStatuses'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'DatabaseEShopContext.OrderStatuses'  is null.");
            }
            var orderStatus = await _context.OrderStatuses.FindAsync(id);
            if (orderStatus != null)
            {
